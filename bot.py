...
# Constant
DISCORD_TOKEN = "MzQ3MTM0MDM4MjEwNzcyOTky.DfhX7g.Rtmzuy-016Mw-w7l6MxydkpC7_A"

FORTNITE_API_KEY = '83f4c3be-1fdb-49a1-9d8b-c69e0a274f25'

LISTE = ['Wood', 'Carton', 'Bronze', 'Silver', 'Gold', 'Platinum', 'Diamond', 'Ruby', 'Royality', 'Illuminati', 'Hacker']
WOOD_B = 0.00
WOOD_E = 0.99
CARTON_B = 1.00
CARTON_E = 1.49
